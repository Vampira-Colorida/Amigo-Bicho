...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center w3-animate-left">
  ...
  <a href="CadastrarFornecedor.php" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
    <i class="fa fa-money" style="font-size:48px; color: #e1e1d0"></i>
    <p class="corLetraNavbar">Cadastrar Fornecedor</p>
  </a>
...
<div class="w3-hide-large w3-hide-medium" id="myNavbar">
  <div class="w3-bar w3-black w3-opacity w3-hover-opacity-off w3-center w3-small">
    ...
    <a href="CadastrarFornecedor.php.php" class="w3-bar-item w3-button" style="width:25% !important">CADASTRAR FORNECEDOR</a>
    <a href="Funcionarios.php" class="w3-bar-item w3-button" style="width:25% !important">B</a>
    <a href="#Estoque.php" class="w3-bar-item w3-button" style="width:25% !important">C</a>
