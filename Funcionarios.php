...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center w3-animate-left">
  ...
  <a href="CadastrarF.php" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
    <i class="fa fa-address-book" style="font-size:48px; color: #e1e1d0"></i>
    <p class="corLetraNavbar">Cadastrar</p>
  </a>
  <a href="GerenciarF.php" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
